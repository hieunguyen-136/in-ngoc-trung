...
export function HeroSection() {
  return (
    <section className="min-h-screen bg-gradient-to-b from-white to-pink-50 flex flex-col items-center justify-center px-4 text-center">
      {/* Eyebrow */}
      <p
        className="font-sans font-semibold uppercase text-pink-500"
        style={{ fontSize: '12px', letterSpacing: '0.28em', marginBottom: '18px' }}
      >
        IN ẤN CHUYÊN NGHIỆP
      </p>
      ...
      <h1
        ...
        style={{ fontSize: 'clamp(56px, 9vw, 116px)', letterSpacing: '0.01em', lineHeight: 1.05 }}
      >
        In Ngọc Trung
      </h1>
      ...
      <p
        ...
        style={{ fontSize: 'clamp(16px, 1.4vw, 19px)', letterSpacing: '0.04em', marginTop: '20px' }}
      >
        Chất lượng cao · Giao nhanh · Giá tốt
      </p>

      {/* CTA Buttons */}
      <div className="flex flex-wrap gap-[14px] justify-center" style={{ marginTop: '48px' }}>
        {/* Messenger */}
        <Link
          href={messengerUrl()}
          target="_blank"
